    ...
    <>
      <header className="mobile-header" aria-label="Mobile site header">
        <a
          ...
          aria-label="Farrukh Sultan home"
        >
          <img src="/farrukh-favicon.png" alt="" />
        </a>
        <div className="mobile-header-actions">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="WhatsApp Farrukh Sultan"
          >
            <MessageCircle size={17} />
          </a>
          <a className="mobile-talk" href="mailto:farukhsultan.dev@gmail.com">
      ...
      >
        <div className="mobile-menu-intro">
          <span>Farrukh Sultan</span>
          <strong>Shopify Plus · Full Stack · AI</strong>
          <p>Selected work, engineering depth and production experience.</p>
        </div>
